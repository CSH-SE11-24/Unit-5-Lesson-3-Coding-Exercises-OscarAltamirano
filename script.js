...
let vanillaALso = document.querySelector("vanillaImage")

// Console log the variable to confirm you selected it correctly!
console.log("vinallaAlso")
// CODING EXERCISES
// Task 1: 
...
console.log(document["body"].classNaame)
...
let chocolateALso = document.querySelector("chocolateImage")

// Console log the variable to confirm you selected it correctly!
console.log("chocolateALso")
